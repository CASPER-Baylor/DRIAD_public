 ...
 *	device_launch_parameters.h
 */
template <class Type> class constCUDAvar
{
 ...
 *
 */
template <class Type> constCUDAvar<Type>::constCUDAvar(const Type *newHostPtr, int newMemSize)
{
 ...
 *
 */
template <class Type> constCUDAvar<Type>::~constCUDAvar() { cudaFree(devPtr); }
 ...
 *
 */
template <class Type> bool constCUDAvar<Type>::checkHostPtr(const Type *ptr)
{
    if (ptr == hostPtr)
    {
        return true;
 ...
 *
 */
template <class Type> bool constCUDAvar<Type>::compare()
{
