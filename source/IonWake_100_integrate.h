 ...
 *	device_launch_parameters.h
 */
__global__ void kick_100(float4 *, float4 *, const float *);
/*
 *
 * Name:  drift_100
 * Editors
 ...
 *	device_launch_parameters.h
 */
__global__ void drift_100(float4 *, float4 *, const float *);
 ...
 *
 */
__global__ void select_100(float4 *, float4 *, float4 *, float *, const float *, const float *,
                           const int *, const float *, int *const, int *, int *);
 ...
 *
 */
__global__ void KDK_100(float4 *, float4 *, float4 *, float4 *, int *, float *, const float *,
                        const float *, const int, const float *, const float *, const float *,
                        const int *, float4 *, const int *, const float *, const float *,
                        const float *);
