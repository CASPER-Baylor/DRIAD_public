 ...
 *
 */
__global__ void checkIonDustBounds_101(float4 *const, int *, float *const, int *const,
                                       float4 *const);
 ...
 *
 */
__global__ void injectIonSphere_101(float4 *, float4 *, float4 *, curandState_t *const,
                                    float *const, int *const, float *const, float *const,
                                    float *const, int *const, int *const, float *const,
                                    float *const, float *const, float *const, float *const,
                                    float *const, float *const, float *const, int);
 ...
 *
 */
__global__ void injectIonCylinder_101(float4 *, float4 *, float4 *, curandState_t *const,
                                      float *const, float *const, int *const, float *const,
                                      float *const, float *const, int *const, int *const,
                                      float *const, float *const, float *const, float *const,
                                      float *const, float *const, float *const, float *const, int,
                                      float, int);
 ...
 *
 */
void initInjectIonSphere_101(const int, const int, const float, const float, const float,
                             const float, const float, const float, const float, float *, float *,
                             float *, const bool, std::ostream &);
...
void initInjectIonCylinder_101(const int, const int, const int, const float, const float, float *,
                               float *, float *, float *, const float, const float, const float,
                               float *, float *, float *, const bool, std::ostream &);
 ...
 */
__device__ float tile_calculation_101(float2 myPosition, float invdebye, float ni, float V);
 ...
 */
__device__ float pointPointPotential_101(float2, float4, float, float, float);
