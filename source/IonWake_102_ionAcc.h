...
__global__ void calcIonAccels_102(float4 *, float4 *, int *const, float *const, float *const,
                                  float *const, float *, float *const, float *, int *, int *,
                                  float *, float *, float *, float *, int, int, int, float *const);
