...
IonWake_101_bounds.o: IonWake_101_bounds.cu IonWake_101_bounds.h
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $< -Wno-deprecated-gpu-targets
	@echo " "
...
run: build
	@echo " "
	$(EXEC) ./IonWake_000 -Wno-deprecated-gpu-targets

clean:
	rm -f IonWake_000 IonWake_000.o 
	rm -rf ../../bin/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/IonWake_000
