 ...
 *
 */
void setIonCrossSection_105(const int, const int, const float, const float, float *, float *,
                            float *, float &, const bool, std::ostream &);
...
//		int*,
//		float* const,
__global__ void ionCollisions_105(int *, float *const, float *const, float *const, int *const,
                                  float *const, float *, float *, float *, float4 *,
...
__global__ void setCollisionList_105(int *, int);
